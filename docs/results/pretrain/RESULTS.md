...
|---|---|---|---|---|---|---|---|---|
| C->C | in-domain | VICRegL | 1074 | 0.992 [0.983, 0.998] | 0.993 | 0.992 [0.985, 0.998] | 0.992 | 0.992 |
| C->C | in-domain | RF-binned | 1074 | 0.997 [0.990, 1.000] | 0.999 | 0.998 [0.994, 1.000] | 0.999 | 0.999 |
| B->B | in-domain | VICRegL | 847 | 0.995 [0.990, 1.000] | 0.996 | 0.995 [0.988, 1.000] | 0.996 | 0.996 |
| B->B | in-domain | RF-binned | 847 | 0.994 [0.980, 1.000] | 0.999 | 0.997 [0.988, 1.000] | 0.999 | 0.999 |
| C->B | cross-center | VICRegL | 2821 | 0.995 [0.990, 0.999] | 0.996 | 0.993 [0.987, 0.997] | 0.995 | 0.995 |
| C->B | cross-center | RF-binned | 2821 | 0.992 [0.985, 0.998] | 0.996 | 0.994 [0.989, 0.998] | 0.995 | 0.995 |
| B->C | cross-center | VICRegL | 3580 | 0.982 [0.976, 0.987] | 0.987 | 0.972 [0.958, 0.983] | 0.985 | 0.985 |
...
|---|---|---|---|---|
| VICRegL | 0.982 | 0.995 | 0.991 | **0.013** |
